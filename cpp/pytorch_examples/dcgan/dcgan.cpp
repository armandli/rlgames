...
const char* kDataFolder = "/home/armandli/rlgames/data";
...
//// Alternative way of implementing Generator using object oriented way
...
int main(int argc, const char* argv[]) {
  ...
  nn::Sequential discriminator(
      ...
      nn::Functional(torch::leaky_relu, 0.2), //notice discriminator uses the leaky relu
      // Layer 2
      nn::Conv2d(
  ...
  // print labels from each batch in data loader
  ...
  //As of this writing, the C++ frontend provides optimizers implementing Adagrad, Adam, LBFGS, RMSprop and SGD
