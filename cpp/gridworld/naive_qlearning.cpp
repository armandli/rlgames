...
int main(int argc, char* argv[]){
  ...
  m::naive_qlearning<decltype(env), decltype(rlm), g::GridWorld, g::Action>(env, rlm, 1000, 0.9, 1., losses, env.state_size() / 4);

  m::simulate_gridworld(env, rlm, env.state_size() / 4);
