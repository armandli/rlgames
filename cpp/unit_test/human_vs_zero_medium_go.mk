app=human_vs_zero_medium_go

SOURCES=human_vs_zero_medium_go.cpp
...
OPT=-O3
LIBS=-lpthread -lc10 -lc10_cuda -ltorch -lcaffe2_nvrtc -lcaffe2_observers -lcaffe2_detectron_ops_gpu -lcaffe2_module_test_dynamic -lshm
DEFINES=
