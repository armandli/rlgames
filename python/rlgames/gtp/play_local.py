...
from rlgames.agent.termination import PassWhenOpponentPasses, TerminationAgent
from rlgames.gtp.board import gtp_position_to_coord, coord_to_gtp_position

#TODO: SGFWriter for gtp
...
class LocalGtpBot:
  def __init__(self, gobot, termination=None, handicap=0, opponent='gnugo', output_sgf='out.sgf', our_color='b'):
    ...
    #self.sgf = SGFWriter(output_sgf) #TODO: need SGFWriter
    self.our_color = Player.black if our_color == 'b' else Player.white
    self.their_color = self.our_color.other #TODO: does this work ?
...
if __name__ == '__main__':
  agent_file = '/home/armandli/rlgames/data/checkpoints/sevenplane_large_agent.h5'
