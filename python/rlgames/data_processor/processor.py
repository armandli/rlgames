...
class DataProcessor:
  ...
  def load_data(self, data_type='train', num_samples=1000, download=False):
    ...
    for zip_name in zip_names:
      ...
      if not os.path.isfile(self.data_dir + '/' + data_file_name):
        print('Processing file {}'.format(data_file_name))
  ...
  def consolidate_games(self, data_file, samples):
    files_needed = set(file_name for file_name, index in samples)
    file_names = []
    for zip_file_name in files_needed:
      file_name = zip_file_name.replace('.tar.gz', '') + data_file
    ...
    np.save('{}/features_{}.npy'.format(self.data_dir, data_file), features)
    np.save('{}/labels_{}.npy'.format(self.data_dir, data_file), labels)
